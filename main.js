function startClassification()
{
  ...
  classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/x2BOoSI5_/model.json', { probabilityThreshold: 0.7 } ,modelReady);
}
